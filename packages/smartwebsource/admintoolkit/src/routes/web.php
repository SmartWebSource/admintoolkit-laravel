...
Route::get('ecommerce', function () {
    return view('admin::pages.ecommerce');
...
Route::get('invoice-create', function () {
    return view('admin::pages.invoice_create');
})->name('invoice.create');

Route::get('invoice-details', function () {
    return view('admin::pages.invoice_details');
...
Route::get('product-edit', function () {
    return view('admin::pages.product_edit');
...
Route::get('customer-list', function () {
    return view('admin::pages.customer_list');
...
Route::get('accordion', function () {
    return view('admin::pages.accordion');
});
...
Route::get('avater', function () {
    return view('admin::pages.avater');
});

Route::get('badge', function () {
    return view('admin::pages.badge');
...
Route::get('drawer', function () {
    return view('admin::pages.drawer');
})->name('components.drawer');

Route::get('dropdown', function () {
    return view('admin::pages.dropdown');
})->name('components.dropdown');

Route::get('list-group', function () {
    return view('admin::pages.list_group');
})->name('components.list-group');

Route::get('modal', function () {
    return view('admin::pages.modal');
})->name('components.modal');

Route::get('pagination', function () {
    return view('admin::pages.pagination');
})->name('components.pagination');

Route::get('progress', function () {
    return view('admin::pages.progress');
})->name('components.progress');

Route::get('skeleton', function () {
    return view('admin::pages.skeleton');
})->name('components.skeleton');

Route::get('spinner', function () {
    return view('admin::pages.spinner');
})->name('components.spinner');

Route::get('tab', function () {
    return view('admin::pages.tab');
})->name('components.tab');

Route::get('toast', function () {
    return view('admin::pages.toast');
})->name('components.toast');


Route::get('tooltip', function () {
    return view('admin::pages.tooltip');
})->name('components.tooltip');

//form
Route::get('input', function () {
    return view('admin::pages.input');
})->name('form.input');

Route::get('input-group', function () {
    return view('admin::pages.input_group');
})->name('form.input_group');

Route::get('textarea', function () {
    return view('admin::pages.textarea');
})->name('form.textarea');

Route::get('checkbox', function () {
    return view('admin::pages.checkbox');
})->name('form.checkbox');

Route::get('radio', function () {
    return view('admin::pages.radio');
})->name('form.radio');

Route::get('toggle', function () {
    return view('admin::pages.toggle');
})->name('form.toggle');

Route::get('select', function () {
    return view('admin::pages.select');
})->name('form.select');
...
Route::get('layout', function () {
    return view('admin::pages.form_layout');
})->name('form.layout');
...
Route::get('data-table', function () {
    return view('admin::pages.data_table');
...
Route::get('forget-password', function () {
    return view('admin::pages.forger_password');
